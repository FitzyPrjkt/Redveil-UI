...
# Prefer the upstream redveil.probe.runner when the installed redveil
# library exposes it; otherwise fall back to the vendored runner in
# redveil_ui.probe_runner. Both expose the same surface.
try:
    from redveil.probe.runner import (  # type: ignore[import-not-found]
    ...
    from redveil_ui.probe_runner import (
        CUSTOM_PROBE_CHECK_ID,
        DWYOR_CONFIRM_STRING,
        ProbeRunResult,
        ProbeRunner,
